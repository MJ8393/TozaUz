...
class RecoverPassCell: UITableViewCell {
    ...
    lazy var smsTextField: UITextField = {
        ...
        let placeholderText = "sms_text_er" .translate()
    ...
    private func initViews() {
        ...
        subView.addSubview(smsTextField)
...
extension RecoverPassCell: UITextFieldDelegate {
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        if textField.tag == 0 {
            smsTextField.layer.borderColor = AppColors.mainColor.cgColor
        } else {
    ...
    func textFieldShouldEndEditing(_ textField: UITextField) -> Bool {
        if textField.tag == 0 {
            smsTextField.layer.borderColor = UIColor.clear.cgColor
        } else {
