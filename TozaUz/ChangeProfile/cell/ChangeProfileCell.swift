...
class ChangeProfileCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        smsTextField.text = UD.firstName ?? ""
        passwordTextField.text = UD.lastName ?? ""
    }
...
extension ChangeProfileCell: UITextFieldDelegate {
